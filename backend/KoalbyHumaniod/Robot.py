...
class SimRobot(Robot):
    ...
    def motors_init(self):
        ...
        for motorConfig in config.motors:
            ...
            vrep.simxSetObjectFloatParameter(self.client_id, handle, vrep.sim_shapefloatparam_mass, 1,
    ...
    def get_imu_data(self):
        data = [vrep.simxGetFloatSignal(self.client_id, "gyroX", vrep.simx_opmode_streaming)[1]+.001,
                ...
                vrep.simxGetFloatSignal(self.client_id, "accelerometerZ", vrep.simx_opmode_streaming)[1]+.001, 1, 1, 1]
